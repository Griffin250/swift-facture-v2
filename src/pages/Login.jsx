        ...
        <div className="bg-white rounded-lg shadow-lg border border-gray-200/50 p-8">
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-white text-gray-500">{t('auth.divider') || 'or'}</span>
            </div>
          </div>
          ...
          <div className="space-y-3 mb-6">
            <button 
              ...
              {t('buttons.continueWithGoogle') || 'Continue with Google'}
            </button>
            ...
            <button 
              ...
              {t('buttons.continueWithGitHub') || 'Continue with GitHub'}
            </button>
             */}
          </div>
